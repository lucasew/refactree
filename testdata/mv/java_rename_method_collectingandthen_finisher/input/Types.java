...
class Uses {
  public static int useFinisherGet0(List<A> as, List<B> bs) {
    return as.stream().collect(Collectors.collectingAndThen(Collectors.toList(), l -> l.get(0))).run()
  ...
  public static int useFinisherToSet(List<A> as, List<B> bs) {
    return as.stream().collect(Collectors.collectingAndThen(Collectors.toSet(), l -> l.iterator().next())).run()
  ...
  public static int useFinisherGetFirst(List<A> as, List<B> bs) {
    return as.stream().collect(Collectors.collectingAndThen(Collectors.toList(), l -> l.getFirst())).run()
  ...
  public static int useFinisherMethodRef(List<A> as, List<B> bs) {
    return as.stream().collect(Collectors.collectingAndThen(Collectors.toList(), List::getFirst)).run()
