...
function useEntriesInline() {
  return (
    Object.entries(Object.groupBy([new A()], (x) => "k"))[0][1][0].execute() +
...
function useEntriesLocal() {
  ...
  return Object.entries(ga)[0][1][0].execute() + Object.entries(gb)[0][1][0].run();
}
...
function useEntriesSpread() {
  ...
  const gb = Object.groupBy([new B()], (x) => "k");
  return (
    [...Object.entries(ga)][0][1][0].execute() + [...Object.entries(gb)][0][1][0].run()
  );
}
