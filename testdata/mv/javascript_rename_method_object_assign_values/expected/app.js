...
function useAssignValues() {
  return (
    Object.values(Object.assign({}, { k: new A() }))[0].execute() +
...
function useAssignValuesMultiSame() {
  return (
    Object.values(Object.assign({}, { k: new A() }, { j: new A() }))[0].execute() +
...
function useIdent() {
  ...
  const b0 = new B();
  return (
    Object.values(Object.assign({}, { k: a0 }))[0].execute() +
...
function useShorthand() {
  ...
  const b0 = new B();
  return (
    Object.values(Object.assign({}, { a0 }))[0].execute() +
