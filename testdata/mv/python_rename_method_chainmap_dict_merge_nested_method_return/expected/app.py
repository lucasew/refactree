...
def use_class_chainmap_od() -> int:
    return (
        ChainMap(OrderedDict(k=[A()]))["k"][0].execute()
...
def use_mr_chainmap_od(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap(OrderedDict(k=[ba.get()]))["k"][0].execute()
...
def use_mr_chainmap_multi(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": [ba.get()]}, {"m": [ba.get()]})["k"][0].execute()
...
def use_mr_chainmap_get(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": [ba.get()]}).get("k")[0].execute()
