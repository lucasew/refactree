...
def use_class_nc_nested_sub() -> int:
    return (
        ChainMap({"k": [A()]}).new_child()["k"][0].execute()
...
def use_class_nc_scalar() -> int:
    return (
        ChainMap({"k": A()}).new_child()["k"].execute()
...
def use_class_nc_scalar_get() -> int:
    return (
        ChainMap({"k": A()}).new_child().get("k").execute()
...
def use_class_nc_assign_nested() -> int:
    ...
    return ca["k"][0].execute() + cb["k"][0].run()
...
def use_class_nc_with_child() -> int:
    return (
        ChainMap({"k": [A()]}).new_child({"m": [A()]})["m"][0].execute()
...
def use_class_nc_od() -> int:
    return (
        ChainMap(OrderedDict(k=[A()])).new_child()["k"][0].execute()
...
def use_class_coll_nc() -> int:
    return (
        collections.ChainMap({"k": [A()]}).new_child()["k"][0].execute()
...
def use_mr_nc_nested_sub(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": [ba.get()]}).new_child()["k"][0].execute()
...
def use_mr_nc_scalar(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}).new_child()["k"].execute()
...
def use_mr_nc_scalar_get(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}).new_child().get("k").execute()
...
def use_mr_nc_with_child(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": [ba.get()]}).new_child({"m": [ba.get()]})["m"][0].execute()
...
def use_mr_nc_od(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap(OrderedDict(k=[ba.get()])).new_child()["k"][0].execute()
...
def use_mr_coll_nc(ba: BoxA, bb: BoxB) -> int:
    return (
        collections.ChainMap({"k": [ba.get()]}).new_child()["k"][0].execute()
