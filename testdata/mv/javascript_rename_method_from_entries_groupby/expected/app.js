...
function useFromEntriesInline() {
  return (
    Object.fromEntries(Object.entries(Object.groupBy([new A()], (x) => "k")))["k"][0].execute() +
...
function useFromEntriesLocal() {
  ...
  return (
    Object.fromEntries(Object.entries(ga))["k"][0].execute() +
...
function useFromEntriesDot() {
  const ga = Object.groupBy([new A()], (x) => "k");
  const gb = Object.groupBy([new B()], (x) => "k");
  return Object.fromEntries(Object.entries(ga)).k[0].execute() + Object.fromEntries(Object.entries(gb)).k[0].run();
}
