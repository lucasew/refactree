...
def use_class_deepcopy_values() -> int:
    return (
        list(copy.deepcopy({"k": A()}).values())[0].run()
...
def use_class_deepcopy_od() -> int:
    return (
        copy.deepcopy(OrderedDict(k=A()))["k"].run()
...
def use_mr_deepcopy_get(ba: BoxA, bb: BoxB) -> int:
    return (
        copy.deepcopy({"k": ba.get()}).get("k").run()
...
def use_mr_deepcopy_values(ba: BoxA, bb: BoxB) -> int:
    return (
        list(copy.deepcopy({"k": ba.get()}).values())[0].run()
...
def use_mr_deepcopy_od(ba: BoxA, bb: BoxB) -> int:
    return (
        copy.deepcopy(OrderedDict(k=ba.get()))["k"].run()
...
def use_mr_deepcopy_dict_ctor(ba: BoxA, bb: BoxB) -> int:
    return (
        copy.deepcopy(dict(k=ba.get()))["k"].run()
...
def use_mr_bare_deepcopy(ba: BoxA, bb: BoxB) -> int:
    ...
    return deepcopy({"k": ba.get()})["k"].run() + deepcopy({"k": bb.get()})["k"].run()
