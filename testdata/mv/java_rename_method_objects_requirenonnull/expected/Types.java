...
class Uses {
  public static int useRequireNonNull(A a, B b) {
    return Objects.requireNonNull(a).execute() + Objects.requireNonNull(b).run();
  }
  ...
  public static int useRequireNonNullMsg(A a, B b) {
    return Objects.requireNonNull(a, "a").execute() + Objects.requireNonNull(b, "b").run();
  }
  ...
  public static int useRequireNonNullNew() {
    return Objects.requireNonNull(new A()).execute() + Objects.requireNonNull(new B()).run();
  }
  ...
  public static int useRequireNonNullGet(List<A> as, List<B> bs) {
    return Objects.requireNonNull(as.get(0)).execute() + Objects.requireNonNull(bs.get(0)).run();
  }
