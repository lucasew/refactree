...
class Uses {
  public static int useGetAndSet(AtomicReference<A> aa, AtomicReference<B> ab) {
    return aa.getAndSet(null).run() + ab.getAndSet(null).run();
  }
