...
def use_class_parents_lit() -> int:
    return (
        ChainMap({"k": A()}, {"j": A()}).parents["k"].execute()
...
def use_class_parents_get() -> int:
    return (
        ChainMap({"k": A()}, {"j": A()}).parents.get("k").execute()
...
def use_class_parents_values() -> int:
    return (
        list(ChainMap({"k": A()}, {"j": A()}).parents.values())[0].execute()
...
def use_class_coll_parents() -> int:
    return (
        collections.ChainMap({"k": A()}, {"j": A()}).parents["k"].execute()
...
def use_class_od_parents() -> int:
    return (
        ChainMap(OrderedDict(k=A()), OrderedDict(k=A())).parents["k"].execute()
...
def use_mr_parents_sub(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}, {"j": ba.get()}).parents["k"].execute()
...
def use_mr_parents_get(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}, {"j": ba.get()}).parents.get("k").execute()
...
def use_mr_coll_parents(ba: BoxA, bb: BoxB) -> int:
    return (
        collections.ChainMap({"k": ba.get()}, {"j": ba.get()}).parents["k"].execute()
...
def use_mr_od_parents(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap(OrderedDict(k=ba.get()), OrderedDict(k=ba.get())).parents["k"].execute()
...
def use_mr_parents_values(ba: BoxA, bb: BoxB) -> int:
    return (
        list(ChainMap({"k": ba.get()}, {"j": ba.get()}).parents.values())[0].execute()
