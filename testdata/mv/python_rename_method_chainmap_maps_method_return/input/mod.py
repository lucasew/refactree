...
def use_class_coll_maps() -> int:
    return (
        collections.ChainMap({"k": A()}).maps[0]["k"].run()
...
def use_class_od_maps() -> int:
    return (
        ChainMap(OrderedDict(k=A())).maps[0]["k"].run()
...
def use_class_nc_maps1() -> int:
    return (
        ChainMap({"k": A()}).new_child().maps[1]["k"].run()
...
def use_class_maps_values() -> int:
    return (
        list(ChainMap({"k": A()}).maps[0].values())[0].run()
...
def use_mr_maps_sub(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}).maps[0]["k"].run()
...
def use_mr_maps_get(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}).maps[0].get("k").run()
...
def use_mr_coll_maps(ba: BoxA, bb: BoxB) -> int:
    return (
        collections.ChainMap({"k": ba.get()}).maps[0]["k"].run()
...
def use_mr_od_maps(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap(OrderedDict(k=ba.get())).maps[0]["k"].run()
...
def use_mr_maps_multi(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}, {"j": ba.get()}).maps[0]["k"].run()
...
def use_mr_nc_maps1(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}).new_child().maps[1]["k"].run()
...
def use_mr_maps_values(ba: BoxA, bb: BoxB) -> int:
    return (
        list(ChainMap({"k": ba.get()}).maps[0].values())[0].run()
