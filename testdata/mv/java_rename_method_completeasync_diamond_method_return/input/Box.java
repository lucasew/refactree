...
class Use {
  ...
  int useDiamondJoin(BoxA ba, BoxB bb) {
    return new CompletableFuture<>().completeAsync(() -> ba.get()).join().run()
  ...
  int useDiamondExecutor(BoxA ba, BoxB bb) {
    ...
    return new CompletableFuture<>().completeAsync(() -> ba.get(), ex).join().run()
  ...
  int useDiamondThenApply(BoxA ba, BoxB bb) {
    return new CompletableFuture<>().completeAsync(() -> ba.get()).thenApply(x -> x).join().run()
  ...
  int useTypedJoin(BoxA ba, BoxB bb) {
    return new CompletableFuture<A>().completeAsync(() -> ba.get()).join().run()
