...
class Uses {
  public static int useFQNCopies() {
    java.util.Collections.nCopies(1, new A()).forEach(x1 -> x1.run());
    java.util.Collections.nCopies(1, new B()).forEach(y1 -> y1.run());
    return 0;
  }

  public static int useFQSingletonList() {
    java.util.Collections.singletonList(new A()).forEach(x2 -> x2.run());
