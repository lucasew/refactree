...
class Uses {
  ...
  public static int useCompletedThenApplyJoin() {
    return CompletableFuture.completedFuture(new A()).thenApply(x1 -> x1).join().execute()
