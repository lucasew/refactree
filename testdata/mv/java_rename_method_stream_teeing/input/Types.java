...
class Uses {
  public static int useTeeingList(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.teeing(Collectors.toList(), Collectors.counting(), (xs, n) -> xs)).forEach(a -> a.run());
  ...
  public static int useTeeingSecondList(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.teeing(Collectors.counting(), Collectors.toList(), (n, xs) -> xs)).forEach(a -> a.run());
  ...
  public static int useTeeingToSet(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.teeing(Collectors.toSet(), Collectors.counting(), (xs, n) -> xs)).forEach(a -> a.run());
