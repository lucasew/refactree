...
def use_class_cm_copy_get() -> int:
    return (
        ChainMap({"k": A()}).copy().get("k").execute()
...
def use_class_cm_copy_multi() -> int:
    return (
        ChainMap({"k": A()}, {"j": A()}).copy()["k"].execute()
...
def use_class_coll_cm_copy() -> int:
    return (
        collections.ChainMap({"k": A()}).copy()["k"].execute()
...
def use_class_od_cm_copy() -> int:
    return (
        ChainMap(OrderedDict(k=A())).copy()["k"].execute()
...
def use_mr_cm_copy_sub(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}).copy()["k"].execute()
...
def use_mr_cm_copy_get(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}).copy().get("k").execute()
...
def use_mr_cm_copy_multi(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap({"k": ba.get()}, {"j": ba.get()}).copy()["k"].execute()
...
def use_mr_coll_cm_copy(ba: BoxA, bb: BoxB) -> int:
    return (
        collections.ChainMap({"k": ba.get()}).copy()["k"].execute()
...
def use_mr_od_cm_copy(ba: BoxA, bb: BoxB) -> int:
    return (
        ChainMap(OrderedDict(k=ba.get())).copy()["k"].execute()
