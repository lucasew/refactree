...
class Uses {
  public static int useGroupingByToList(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.groupingBy(a -> "k", Collectors.toList())).get("k").get(0).run();
  ...
  public static int useGroupingByMapFactory(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.groupingBy(a -> "k", HashMap::new, Collectors.toList())).get("k").get(0).run();
  ...
  public static int usePartitioningByToList(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.partitioningBy(a -> true, Collectors.toList())).get(true).get(0).run();
