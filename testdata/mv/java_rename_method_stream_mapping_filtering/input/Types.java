...
class Uses {
  public static int useFilteringForEach(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.filtering(a -> true, Collectors.toList())).forEach(a -> a.run());
  ...
  public static int useMappingForEach(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.mapping(a -> a, Collectors.toList())).forEach(a -> a.run());
  ...
  public static int useFilteringToSet(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.filtering(a -> true, Collectors.toSet())).forEach(a -> a.run());
  ...
  public static int useMappingToSet(List<A> as, List<B> bs) {
    as.stream().collect(Collectors.mapping(a -> a, Collectors.toSet())).forEach(a -> a.run());
