...
def use_next_values():
    return (
        next(iter(dict.fromkeys(["k"], A()).values())).execute()
...
def use_next_values_direct():
    return (
        next(dict.fromkeys(["k"], A()).values()).execute()
...
def use_list_values_index():
    return (
        list(dict.fromkeys(["k"], A()).values())[0].execute()
...
def use_fromkeys_value_kw():
    return (
        next(iter(dict.fromkeys(["k"], value=A()).values())).execute()
...
def use_min_values():
    return (
        min(dict.fromkeys(["k"], A()).values()).execute()
...
def use_max_values():
    return (
        max(dict.fromkeys(["k"], A()).values()).execute()
