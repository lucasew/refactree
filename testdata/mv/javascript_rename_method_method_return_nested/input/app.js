...
export function useGet() {
  return new BoxA().get().helper() + new BoxB().get().helper();
}
...
export function useStatic() {
  return A.create().helper() + B.create().helper();
}
...
export function useNested() {
  return new OuterA().box.a.helper() + new OuterB().box.b.helper();
}
export function useNestedAssign() {
  const oa = new OuterA();
  const ob = new OuterB();
  return oa.box.a.helper() + ob.box.b.helper();
}
