...
function useFromEntriesMapLocal() {
  ...
  return Object.fromEntries(ma).k.run() + Object.fromEntries(mb).k.run();
}
...
function useFromEntriesMapValues() {
  ...
  const mb = new Map([["k", new B()]]);
  return (
    Object.values(Object.fromEntries(ma))[0].run() +
...
function useFromEntriesMapSpread() {
  ...
  const mb = new Map([["k", new B()]]);
  return (
    Object.fromEntries([...ma]).k.run() + Object.fromEntries([...mb]).k.run()
  );
}
...
function useFromEntriesMapEntries() {
  ...
  const mb = new Map([["k", new B()]]);
  return (
    Object.fromEntries(ma.entries()).k.run() +
...
function useFromEntriesNewMap() {
  return (
    Object.fromEntries(new Map([["k", new A()]])).k.run() +
...
function useFromEntriesArrayFrom() {
  ...
  const mb = new Map([["k", new B()]]);
  return (
    Object.fromEntries(Array.from(ma)).k.run() +
